...
// SimpleParser is a concrete strategy that parses the query using simple string manipulation
...
func main() {
	...
	// Dynamically choose strategy based on runtime requirements
	...
	// Add more strategies and switch between them as needed
}
